...
import org.ktorm.support.dameng.DamengDialect
...
class TestDameng {
    ...
    @Test
    fun test() {
        val db = Database.connect(url = "jdbc:dm://localhost:5236", driver = "dm.jdbc.driver.DmDriver", user = "SYSDBA", password = "SYSDBA001", dialect = DamengDialect(), logger = ConsoleLogger(LogLevel.DEBUG))
